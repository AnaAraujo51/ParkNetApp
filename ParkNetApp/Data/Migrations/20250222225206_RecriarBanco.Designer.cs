...
namespace ParkNetApp.Data.Migrations
{
    ...
    [Migration("20250222225206_RecriarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkNetApp.Data.Entities.Estacionamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ParkNetApp.Data.Entities.Parque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Utilizador", b =>
                {
                    ...
                    b.Property<int>("CartaDeConducao")
                        .HasColumnType("int");

                    b.Property<int>("CartaDeCredito")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("ValidadeCrtCredito")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Avenca", b =>
                {
                    b.HasOne("ParkNetApp.Data.Entities.Parque", "Parque")
                        .WithMany()
            ...
            modelBuilder.Entity("Pagamento", b =>
                {
                    b.HasOne("Avenca", "Avenca")
                        .WithMany()
                        .HasForeignKey("AvencaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
